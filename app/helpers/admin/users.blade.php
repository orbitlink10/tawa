                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('admin.save_user') }}">
                                                @csrf
                                        ...
                                        <tbody>
                                            @foreach ($users as $key => $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('login_as', $user->id) }}"
                                                            target="_blank"
                                                            class="btn btn-sm btn-success badge"><i
                                                                class="fa fa-sign-in"></i> Login As
                                                        </a>
                                                        <a href="#" class="btn btn-sm btn-primary badge" data-toggle="modal"
                                                            data-target="#edit-user{{ $user->id }}">update</a>
                                                    </td>
                                                </tr>
